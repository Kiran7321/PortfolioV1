---
title: "Installing Kali Linux on Surface Book with Custom Kernel Support"
publishedAt: "2025-07-23"
summary: "Step-by-step walkthrough of installing Kali Linux on a Microsoft Surface Book, configuring the custom Surface Linux kernel, and resolving common issues such as network compatibility and captive portal access."
images:
